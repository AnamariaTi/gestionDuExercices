...
public class Ex07 {
    ...
    public static void main(String[] args) {
        ...
        String texte6 = clavier.nextLine(); //Entrez "Bonjour" pour l'experience

        System.out.println(texte1 == texte2);// true car on compare juste le texte 
        System.out.println(texte1 + "==" + texte2 + "?" + texte1 == texte2);   //il mettre direct false car il compare direct avec == et ? 
